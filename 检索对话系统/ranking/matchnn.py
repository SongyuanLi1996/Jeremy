...
class BertModelTrain(nn.Module):
    ...
    def __init__(self):
        ...
        self.bert = BertForSequenceClassification.from_pretrained(os.path.join(
            root_path, 'lib/bert/'),
            num_labels=2)
...
class BertModelPredict(nn.Module):
    ...
    def __init__(self):
        ...
        config = BertConfig.from_pretrained(
            os.path.join(root_path, 'lib/bert/config.json'))
